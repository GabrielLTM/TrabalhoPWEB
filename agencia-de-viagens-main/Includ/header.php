    ...
    <div class="container">
        ...
        <nav id="itens">
            ...
            <?php else: ?>
                ...
                <a href="/PHP_SITE_AVIGENCIA_DE_VIAGENS-main/agencia-de-viagens-main/logins/login.php">Login</a>
                <a href="/PHP_SITE_AVIGENCIA_DE_VIAGENS-main/agencia-de-viagens-main/logins/Formulario.php">Criar Conta</a>
            <?php endif; ?>
